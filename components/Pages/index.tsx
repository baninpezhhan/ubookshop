...
const Page: PageEl = (props, state:
  ...
  form:string,
  book:{
    title:string , author:string, country:string , imageLink:string , price:number , language:string, pages:number , },
    cart:Array<string>
  }
  , refresh, getProps) => {
  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh", }}>
      ...
      {state.form == "bookspecs" ? <WindowFloat
        ...
        state.cart.includes(state.book.title)?"#EE7171":"#78E7B0"}}
         onClick={()=>{
